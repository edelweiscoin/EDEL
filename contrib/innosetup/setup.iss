...
#define MyAppName "Edelweis"
#define MyAppPublisher "2022 Edelweis developers"
#define MyAppURL "https://edelweis.org/"
#define MyAppExeName "edelweis-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/EDEL/bootstrap.zip"
...
DefaultDirName={autopf}\Edelweis
...
OutputDir=.\output
OutputBaseFilename=EdelweisSetup
...
DefaultGroupName=Edelweis Core
...
[Files]
Source: ".\package\edelweis-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Edelweis\Edelweis-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Edelweis\Edelweis-Qt,strDataDir|{userappdata}\Edelweis\}');
  Result := True;
end;
