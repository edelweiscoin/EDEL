...
"""Verify that starting edelweis with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start edelweis with -? for help text")
        ...
        self.log.info("Start edelweis with -version for version information")
