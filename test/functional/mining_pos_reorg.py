...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected EDEL and zEDEL supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zEDELsupply']:
                assert_equal(node['zEDELsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check EDEL and zEDEL supply at the beginning
        # ------------------------------------------
        # zEDEL supply: 2 coins for each denomination
        ...
        # EDEL supply: block rewards minus burned fees for minting
        ...
        # Verify that EDEL and zEDEL supplies were properly updated after the spends and reorgs
        self.log.info("Check EDEL and zEDEL supply...")
