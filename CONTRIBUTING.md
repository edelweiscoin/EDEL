Contributing to Edelweis Core
============================

The Edelweis Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/EdelweisBF/Edelweis/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Edelweis Core project, and is not to be
confused with overall Edelweis Network Protocol consensus changes.

Whether a pull request is merged into Edelweis Core rests with the project merge
...
Patches that change Edelweis consensus rules are considerably more involved than
...
Where a patchset proposes to change the Edelweis consensus, it must have been
...
The project leader is the release manager for each Edelweis Core release.
