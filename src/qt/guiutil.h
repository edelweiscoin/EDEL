...
/** Utility functions used by the Edelweis Qt UI.
 */
namespace GUIUtil
{
...
// Render EDEL addresses in monospace font
...
// Parse "edelweis:" URI into recipient object, return true on successful parsing
