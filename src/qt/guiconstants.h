...
/* Edelweis GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Edelweis"
#define QAPP_ORG_DOMAIN "edelweis.org"
#define QAPP_APP_NAME_DEFAULT "Edelweis-Qt"
#define QAPP_APP_NAME_TESTNET "Edelweis-Qt-testnet"
