...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EDEL features */
        {"edelweis", "listmasternodes", &listmasternodes, true },
        {"edelweis", "getmasternodecount", &getmasternodecount, true },
        {"edelweis", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"edelweis", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"edelweis", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"edelweis", "masternodecurrent", &masternodecurrent, true },
        {"edelweis", "startmasternode", &startmasternode, true },
        {"edelweis", "createmasternodekey", &createmasternodekey, true },
        {"edelweis", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"edelweis", "listmasternodeconf", &listmasternodeconf, true },
        {"edelweis", "getmasternodestatus", &getmasternodestatus, true },
        {"edelweis", "getmasternodewinners", &getmasternodewinners, true },
        {"edelweis", "getmasternodescores", &getmasternodescores, true },
        {"edelweis", "preparebudget", &preparebudget, true },
        {"edelweis", "submitbudget", &submitbudget, true },
        {"edelweis", "mnbudgetvote", &mnbudgetvote, true },
        {"edelweis", "getbudgetvotes", &getbudgetvotes, true },
        {"edelweis", "getnextsuperblock", &getnextsuperblock, true },
        {"edelweis", "getbudgetprojection", &getbudgetprojection, true },
        {"edelweis", "getbudgetinfo", &getbudgetinfo, true },
        {"edelweis", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"edelweis", "mnfinalbudget", &mnfinalbudget, true },
        {"edelweis", "checkbudgets", &checkbudgets, true },
        {"edelweis", "mnsync", &mnsync, true },
        {"edelweis", "spork", &spork, true },
        {"edelweis", "getcollateral", &getcollateral, true},
...
{
    return "> edelweis-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41011/\n";
}
