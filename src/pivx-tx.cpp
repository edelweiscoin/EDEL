...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Edelweis edelweis-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  edelweis-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded edelweis transaction") + "\n" +
                               "  edelweis-tx [options] -create [commands]   " + _("Create hex-encoded edelweis transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded edelweis transaction
