...
#define __PORT_MAINNET__ 41010
#define __PORT_TESTNET__ 51010
#define __PORT_REGTEST__ 61010
 ...
 * Edelweis system. There are three: the main network on which people trade goods
